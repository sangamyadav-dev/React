...
export function landing() {
  ...
  return (
    <div className="w-full ">
      <header className="relative felx w-full border-b bg-gray-900 pb-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          <div className="inline-flex items-center space-x-2">
            ...
            <span className="font-bold">IT-TechByte</span>
          </div>
            ...
            <ul className="inline-flex space-x-8">
              {menuItems.map((item) => (
                <li key={item.name}>
                  <a
                    href={item.href}
                    className="text-sm font-semibold text-white hover:text-blue-900"
                  >
                    {item.name}
                  </a>
                </li>
                ...
                <div className="px-5 pb-6 pt-5">
                  <div className="flex items-center justify-between">
                    <div className="inline-flex items-center space-x-2">
                      ...
                      <span className="font-bold text-black">IT-TechByte</span>
                    </div>
                    <div className="-mr-2">
                      <button
                        type="button"
      ...
      {/* Hero Section */}
      <div className="relative w-full bg-grey-50">
        <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
            <div className="mt-8 flex max-w-max items-center space-x-2 rounded-full text-white p-1 ">
               <div className="rounded-full bg-white p-1 px-2">
                    <p className="text-sm font-medium  px-3 py-1 rounded-full text-black">
                        We &apos; hiring
                    </p>
               </div>
              <p className="text-sm font-medium">Join our team &rarr;</p>
            </div>
            <h1 className="mt-8 text-3xl font-bold tracking-tight text-white-900 md:text-4xl lg:text-6xl">
              People who care about your growth
            </h1>
            <p className="mt-8 text-lg text-white-700">
            ...
            <form action="" className="mt-8 flex items-start space-x-2">
              <div>
                <input
                     className="flex w-full rounded-md border border-black/30 bg-transparent px-5 py-2 text-sm placeholder:text-white-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                     type="email"
          ...
          <div className="relative lg:col-span-5 lg:-mr-8 xl:col-span-6">
            <img
              ...
              src="https://images.pexels.com/photos/13620263/pexels-photo-13620263.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt=""
            />
          </div>
        </div>
      ...
      <div className="mx-auto my-32 max-w-7xl px-2 lg:px-8">
        <div className="grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-wheat-600">
              Amet minim mollit non deserunt ullamco est sit aliqua dolor do
              amet sint. Velit officia consequat duis enim velit mollit.
            </p>
          </div>
              ...
              <div className="rounded-md border bg-white bg-opacity-90">
                <div className=" border-b">
                  <div className="px-9 py-7">
                    <h3 className="mb-3 text-3xl font-bold leading-snug text-black">
                      Standard
                    </h3>
                ...
                <div className="px-9 pb-9 pt-8">
                  <p className="mb-6 font-medium leading-relaxed text-black">
                    Features included :
                  </p>
                  <ul className="mb-11 text-black">
            ...
            <div className="w-full p-5 md:w-1/2">
              <div className="rounded-md border bg-white bg-opacity-90">
                ...
                <div className="px-9 pb-9 pt-8">
                  ...
                  <p className="mb-6 text-lg font-semibold leading-normal text-gray-600">
                    <span>Starting from</span>
                    <span className="ml-2 text-gray-900">$149/mo</span>
                  </p>
                  <div className="md:inline-block">
                    <button
                      type="button"
      ...
      <div className="mx-auto mt-12 max-w-7xl">
        <footer className="px-4 py-10">
          <div className="flex flex-col md:flex-row md:items-center">
            ...
            <span className="font-bold m-2">IT-TechByte</span>

            <div className="mt-4 grow md:ml-12 md:mt-0">
              <p className="text-base font-semibold text-white-950">
                © 2023 IT-TechByte Component Library
              </p>
            </div>
          </div>
          <div className="mt-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
            <div className="mb-8 lg:mb-0">
              <p className="mb-6 text-lg font-semibold text-white-700">
                Company
              </p>
            ...
            <div className="mb-8 lg:mb-0">
              <p className="mb-6 text-lg font-semibold text-white-700">Legal</p>
              <ul className="flex flex-col space-y-4 text-[14px] font-medium text-gray-500">
